---
tags: [type/moc, architecture/overview]
---
...
## 🏷️ 標籤字典大綱 (Tag Taxonomy)
本專案橫向聯結與大腦檢索所採用的標準標籤辭典與寫作規範。
**[📂 docs/TAG_INDEX.md](file:///d:/GodotProject/Marble/docs/TAG_INDEX.md)**
...
**[📂 .agents/index.md](file:///d:/GodotProject/Marble/.agents/index.md)**

---
> [!IMPORTANT]
> **AI 運作核心規範 (Systemic Protocols):**
> 1. **技能驅動**: 在執行任務前，請先掃描 `.agents/index.md` 並啟動對應情境的技能模組。
