...
@export var table_2d_scene: PackedScene = preload("res://gameplay/table/MarbleTable.tscn")
@export var peg_3d_scene: PackedScene = preload("res://gameplay/table/deprecated/Peg3D.tscn")
@export var ball_3d_scene: PackedScene = preload("res://gameplay/table/deprecated/Ball3D.tscn")
@export var score_zone_3d_scene: PackedScene = preload("res://gameplay/table/deprecated/ScoreZone3D.tscn")
@export var plunger_3d_scene: PackedScene = preload("res://gameplay/table/deprecated/Plunger3D.tscn")
